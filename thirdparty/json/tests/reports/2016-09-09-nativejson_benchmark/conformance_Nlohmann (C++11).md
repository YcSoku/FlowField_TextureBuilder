...
<meta content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" name="analytics-location" />
  ...
  <body class="logged-uv  env-production  vis-public page-blob">
  ...
  <div class="container-responsive">
    <a class="header-logo-invertocat" href="https://github.com/" aria-label="Homepage" data-ga-click="(Logged uv) Header, go to homepage, icon:logo-wordmark">
    ...
    <div class="site-header-menu">
      ...
      <div class="site-header-actions">
            <a class="btn btn-primary site-header-actions-btn" href="/join?source=header-repo" data-ga-click="(Logged uv) Header, clicked Sign up, text:sign-up">Sign up</a>
          <a class="btn site-header-actions-btn mr-2" href="/login?return_to=%2Fmiloyip%2Fnativejson-benchmark%2Fblob%2Fmaster%2Fsample%2Fconformance_Nlohmann%2520%28C%252B%252B11%29.md" data-ga-click="(Logged uv) Header, clicked Sign in, text:sign-in">Sign in</a>
      </div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <div class="js-stale-session-flash stale-session-flash flash flash-warn flash-banner d-none">
      ...
      <span class="signed-uv-tab-flash">You signed uv in another tab or window. <a href="">Reload</a> to refresh your session.</span>
    </div>
